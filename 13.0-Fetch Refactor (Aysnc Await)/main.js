...
//     fetch(`http://www.omdbapi.com/?apikey=9f206eb8&s=${inputKeyword.value}`)
//         .then(res => res.json())
//         .then(res => {
...
//             const modalMovieDetailButton = document.querySelectorAll('.modal-movie-detail-button')

//             modalMovieDetailButton.forEach(btn => {
//                 btn.addEventListener('click', function() {
//                     const imdbid = this.dataset.imdbid
//                     fetch(`http://www.omdbapi.com/?apikey=9f206eb8&i=${imdbid}`)
//                         .then(res => res.json())
//                         .then(res => {
//                             const movieDetail = showDetailMovie(res)
